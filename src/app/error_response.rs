...
use super::{errors::Error, response_payload::ResponsePayload};
...
impl ErrorMeta {
    ...
    pub const NOT_FOUND: ErrorMeta = ErrorMeta {
        code: Code::NotFound,
        status_code: StatusCode::NOT_FOUND,
        message: Cow::Borrowed("Resourse not found"),
    };

    pub fn make_bad_request(message: Cow<'static, str>) -> Self {
        ErrorMeta {
...
impl ResponseError for ErrorResponse {
    ...
    fn error_response(&self) -> HttpResponse {
        let body = ResponsePayload::error(self.meta.code.raw_value(), self.meta.message.clone());
